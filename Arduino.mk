...
# Local sources
#
LOCAL_C_SRCS    = $(shell find -name $(OBJDIR) -prune -o -type f -a -name '*.c'   -print)
LOCAL_CPP_SRCS  = $(shell find -name $(OBJDIR) -prune -o -type f -a -name '*.cpp' -print)
LOCAL_CC_SRCS   = $(shell find -name $(OBJDIR) -prune -o -type f -a -name '*.cc'  -print)
...
CPPFLAGS      = -mmcu=$(MCU) -DF_CPU=$(F_CPU) \
			-I. -I ./libs -I$(ARDUINO_CORE_PATH) \
			$(SYS_INCLUDES) -g -Os -w -Wall \
			-ffunction-sections -fdata-sections
CFLAGS        = -std=gnu99
CXXFLAGS      = -fno-exceptions
ASFLAGS       = -mmcu=$(MCU) -I. -x assembler-with-cpp
LDFLAGS       = -mmcu=$(MCU) -lm -Wl,--gc-sections -Os -I. -I $(ARDUINO_CORE_PATH)
